...
keys = [
    ...
    Key([mod], "r", lazy.spawn("rofi -show drun -show-icons"), desc="Prompt window"),
...
screens = [
    Screen(
     ...
     #
     #
     #            widget.Systray(margin = 1, padding = 4, background = "#2e3440"),
     #
     #            widget.Sep(
     #                foreground = "#4c566a",
     #                background = "#2e3440",
